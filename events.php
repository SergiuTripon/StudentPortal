...
<div class="preloader"></div>
	...
	<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne"><i class="fa fa-chevron-down"></i>Events - click to minimize or maximize</a>
  	</h4>
    </div>
