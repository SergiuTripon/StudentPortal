...
<div class="preloader"></div>
	...
	$stmt2 = $mysqli->query("SELECT event_amount, ticket_quantity, DATE_FORMAT(booked_on,'%d %b %y %H:%i') as booked_on FROM booked_events LEFT JOIN system_events ON booked_events.eventid=system_events.eventid WHERE userid = '$session_userid'");
