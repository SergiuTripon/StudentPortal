...
<div class="preloader"></div>
	...
	echo '<tr id="cancel-'.$row["eventid"].'">
			...
			<td data-title="Tickets">'.($event_ticket_no === '0' ? "Sold Out" : "$event_ticket_no").'</td>
			<td data-title="Category">'.$event_category.'</td>
			<td data-title="Action"><a class="btn btn-primary btn-md ladda-button" href="../admin/update-book/?'.$eventid.'" data-style="slide-up"><span class="ladda-label">Update</span></a></td>
