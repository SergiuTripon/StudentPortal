...
<body>
	...
	if(password === '') {
        ...
        $("label[for='password']").removeClass("input-success");
        $("label[for='password']").addClass("input-danger");
	}
	...
	if(confirmpwd === '') {
        ...
        $("label[for='confirmpwd']").removeClass("input-success");
        $("label[for='confirmpwd']").addClass("input-danger");
        $("#confirmpwd").focus();
		hasError  = true;
		return false;
    } else {
        ...
        $("label[for='confirmpwd']").removeClass("input-danger");
        $("label[for='confirmpwd']").addClass("input-success");
	}
