...
<body>
    ...
    <!-- Create exam -->
	<form class="form-custom" style="max-width: 100%;" name="createexam_form" id="createexam_form" novalidate>
    ...
    <button id="FormSubmit" class="btn btn-primary btn-lg ladda-button" data-style="slide-up"><span class="ladda-label">Create exam</span></button>
    </div>
