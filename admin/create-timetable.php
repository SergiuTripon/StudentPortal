...
<body>
    ...
    <select class="selectpicker" name="lecturers" id="lecturers" multiple title='Choose one of the following...'>
        <option data-hidden="true" disabled="disabled">Select a lecturer</option>
    <?php
