...
<div class="preloader"></div>
	...
	echo '<tr id="user-'.$row["userid"].'">
			...
			<td data-title="Account type">'.$row["account_type"].'</td>
			<td data-title="Created on">'.$row["created_on"].'</td>
			<td data-title="Delete"><a href="#'.$row["userid"].'" data-toggle="modal"><i class="fa fa-close"></i></a></td>
			</tr>

			<!-- Delete an account modal -->
    		<div class="modal" id="modal-custom '.$row["userid"].'" tabindex="-1" role="dialog" aria-labelledby="modal-custom-label" aria-hidden="true">
