...
$stmt1 = $mysqli->prepare("SELECT user_signin.email, user_details.firstname FROM user_siginin LEFT JOIN user_details ON user_signin.userid=user_details.userid WHERE user_signin.userid = ? LIMIT 1");
$stmt1->bind_param('i', $idToUpdate);
$stmt1->execute();
$stmt1->store_result();
$stmt1->bind_result($firstname, $email);
$stmt1->fetch();
$stmt1->close();
