...
$stmt1 = $mysqli->prepare("SELECT user_signin.email, user_details.firstname FROM user_siginin LEFT JOIN user_details ON user_signin.userid=user_details.userid WHERE user_sigin.userid = ? LIMIT 1");
