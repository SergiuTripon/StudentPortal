...
<body>
    ...
    <!-- Create tutorial -->
	<form class="form-custom" style="max-width: 100%;" name="createtutorial_form" id="createtutorial_form" novalidate>
    ...
    <button id="FormSubmit" class="btn btn-primary btn-lg ladda-button" data-style="slide-up"><span class="ladda-label">Create tutorial</span></button>
    </div>
