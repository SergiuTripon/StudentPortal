...
if (isset($_GET['id'])) {
    ...
    $stmt1 = $mysqli->prepare("SELECT t.moduleid, t.tutorialid, t.tutorial_name, t.tutorial_assistant, t.tutorial_notes, t.tutorial_day, DATE_FORMAT(tutorial_from_time,'%H:%i') AS tutorial_from_time, DATE_FORMAT(tutorial_to_time,'%H:%i') AS tutorial_to_time, t.tutorial_from_date, t.tutorial_to_date, t.tutorial_location, t.tutorial_capacity FROM system_tutorials t WHERE t.tutorialid = ? LIMIT 1");
