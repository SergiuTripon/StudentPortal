...
<div class="preloader"></div>
    ...
    <a class="btn btn-success btn-lg ladda-button mt10" data-style="slide-up" href="../admin/create-book/"><span class="ladda-label"><i class="fa fa-plus"></i> Create book</span></a>
