...
<div class="preloader"></div>
	...
	$stmt1 = $mysqli->query("SELECT system_books.bookid, system_books.book_name, system_books.book_author, system_books.book_notes, system_books.book_copy_no, system_books.book_status FROM system_books LEFT JOIN system_books_reserved ON system_books.bookid=system_books_reserved.bookid WHERE system_books_reserved.book_status = 'reserved' AND NOT system_books_reserved.userid = '$session_userid'");
