...
<div class="preloader"></div>
	...
	echo '<tr id="book-'.$requestid.'">
			...
			<td data-title="Author">'.$book_author.'</td>
			<td data-title="Action"><a class="btn btn-primary btn-md ladda-button" href="../messenger/message-user?id='.$userid.'" data-style="slide-up"><span class="ladda-label">Message</span></a></td>
            <td data-title="Action">'.($isApproved === '1' ? "Approved" : "<a id=\"approve-'.$requestid.'\" class=\"btn btn-primary btn-md ladda-button approve-button\" data-style=\"slide-up\"><span class=\"ladda-label\">Approve request</span></a>").'</td>
			</tr>';
	}
