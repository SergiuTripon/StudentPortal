...
<div class="preloader"></div>
    ...
    $stmt2 = $mysqli->prepare("SELECT bookid FROM system_book_reserved r LEFT JOIN system_book_loaned l ON r.bookid=l.bookid WHERE r.bookid=? AND r.isCollected='0' AND r.reservation_status='active' AND l.isReturned = '0' AND loan_status='active'");
