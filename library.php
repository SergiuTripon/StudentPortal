...
<div class="preloader"></div>
	...
	<a clas="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne"> Available books</a>
  	</h4>
    </div>
	...
	$stmt2 = $mysqli->query("SELECT bookid, DATE_FORMAT(reserved_on,'%d %b %y') as reserved_on, DATE_FORMAT(toreturn_on,'%d %b %y') as toreturn_on, book_name, book_author, book_notes, book_status FROM reserved_books WHERE userid = '$session_userid'");
