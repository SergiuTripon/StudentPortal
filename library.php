...
<div class="preloader"></div>
	...
	echo '<tr>
            ...
            <td data-title="Action"><a id="book-'.$bookid.'" class="btn btn-primary btn-md ladda-button renew-button" data-style="slide-up"><span class="ladda-label">Renew</span></a></td>
			</tr>';
	}
