...
<div class="preloader"></div>
	...
	echo '<tr id="book-'.$bookid.'">
            ...
            <td data-title="Request">'.($stmt3->num_rows == 1 ? "<a class=\"btn btn-primary btn-md ladda-button\" href=\"../library/request-book?id=$bookid\" data-style=\"slide-up\"><span class=\"ladda-label\">$stmt3->num_rows</span></a>" : "-").'</td>
			</tr>';
	}
