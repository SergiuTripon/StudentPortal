...
<div class="preloader"></div>
	...
	$stmt2 = $mysqli->query("SELECT taskid, task_name, task_notes, task_url, DATE_FORMAT(task_startdate,'%d %b %Y') as task_startdate, DATE_FORMAT(task_duedate,'%d %b %Y') as task_duedate, task_category, task_status FROM user_tasks where userid = '$userid'");
