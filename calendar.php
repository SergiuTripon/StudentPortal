...
<div class="preloader"></div>
	...
	success:function(data){
            ...
            $('#complete-'+taskToComplete+''+'#complete-question').removeClass('show');
            $('#complete-'+taskToComplete+''+'#complete-question').addClass('hide');
            $('#complete-'+taskToComplete+''+'#complete-confirmation').removeClass('hide');
            $('#complete-'+taskToComplete+''+'#complete-confirmation').addClass('show');
            $('#complete-'+taskToComplete+''+'#complete-hide').removeClass('show');
            $('#complete-'+taskToComplete+''+'#complete-hide').addClass('hide');
            $('#complete-'+taskToComplete+''+'#complete-success-button').show();
