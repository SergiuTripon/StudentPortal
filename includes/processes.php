...
elseif (isset($_POST["feedback_moduleid"], $_POST["feedback_from_firstname"], $_POST["feedback_from_surname"], $_POST["feedback_from_email"], $_POST["lecturer_feedback_to_email"], $_POST["tutorial_assistant_feedback_to_email"], $_POST["feedback_subject"], $_POST["feedback_body"])) {
    SubmitFeedback();
}
