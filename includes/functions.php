...
function EventsPaypalPaymentSuccess() {
	...
	$stmt1 = $mysqli->prepare("INSERT INTO booked_events (userid, eventid, event_name, event_amount, tickets_quantity, booked_on) VALUES ('2', '1', 'City Careers', '20.00', '2', '$created_on')");
	$stmt1->execute();
	$stmt1->close();
