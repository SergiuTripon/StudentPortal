...
function CollectBook() {
    ...
    $stmt3 = $mysqli->prepare("SELECT r.userid, b.book_name, b.book_author FROM system_book_reserved LEFT JOIN system_book b ON r.bookid=b.bookid WHERE bookid=? ORDER BY bookid DESC LIMIT 1");
