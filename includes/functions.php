...
function calendarUpdate() {
    ...
    global $mysqli;
    global $session_userid;
    global $table_due_tasks;
    global $modal_due_tasks;
    global $table_completed_tasks;
    global $modal_completed_tasks;
    global $table_archived_tasks;
    global $modal_archived_tasks;
    ...
    $table_due_tasks = '<tr id="task-'.$taskid.'">
    ...
    $table_completed_tasks = '<tr id="task-'.$taskid.'">
    ...
    $array = array(
        ...
        'table_archived_tasks'=>$table_archived_tasks,
        'modal_archived_tasks'=>$modal_archived_tasks,
    );
