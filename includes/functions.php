...
function UpdateAnAccount() {
	...
	$stmt2->bind_param('sssissssssssi', $firstname, $surname, $gender, $dateofbirth, $studentno, $phonenumber, $address1, $address2, $town, $city, $country, $postcode, $updated_on, $userid);
	$stmt2->execute();
	$stmt2->close();
	...
	$stmt4->bind_param('sssissssssssi', $firstname, $surname, $gender, $dateofbirth, $studentno, $phonenumber, $address1, $address2, $town, $city, $country, $postcode, $updated_on, $userid);
	$stmt4->execute();
	$stmt4->close();
