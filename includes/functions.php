...
function calendarUpdate() {
    ...
    global $mysqli;
    global $session_userid;
    global $content_due_tasks;
    global $content_completed_tasks;
    global $content_archived_tasks;
    ...
    $array = array(
        'table_due_tasks'=>$content_due_tasks,
        'table_completed_tasks'=>$content_completed_tasks,
        'table_archived_tasks'=>$content_archived_tasks,
    );
