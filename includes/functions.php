...
function CreateLecture() {
    ...
    if ($stmt1->num_rows == 1) {
        ...
        $lecture_from_date = DateTime::createFromFormat('d/m/Y', $lecture_from_time);
        $lecture_from_date = $lecture_from_time->format('Y-m-d');
        $lecture_to_date = DateTime::createFromFormat('d/m/Y', $lecture_to_time);
        $lecture_to_date = $lecture_to_time->format('Y-m-d');
        $lecture_status = 'active';
