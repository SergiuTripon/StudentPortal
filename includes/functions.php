...
function calendarUpdate($isUpdate = 0) {
    ...
    if ($stmt1->num_rows > 0) {
       ...
       '<tr>
        ...
        <div class="modal-header">
        <div class="close" data-dismiss="modal"><i class="fa fa-times"></i></div>
        <h4 class="modal-title" id="modal-custom-label">Update a task</h4>
        </div>
        ...
        <input class="form-control" type="text" name="update_task_startdate" id="update_task_startdate" value="<?php echo $task_startdate; ?>" placeholder="Select a start date and time"/>
        </div>
        <div class="col-xs-6 col-sm-6 full-width">
        <label for="update_task_duedate">Due date and time<span class="field-required">*</span></label>
        <input class="form-control" type="text" name="update_task_duedate" id="update_task_duedate"  value="<?php echo $task_duedate; ?>" placeholder="Select a due date and time"/>
        </div>
        </div>
