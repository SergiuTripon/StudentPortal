...
function CreateTimetable() {
    ...
    $stmt2 = $mysqli->prepare("INSERT INTO system_lectures (lecture_name, lecture_lecturer, lecture_notes) VALUES (?, ?, ?)");
    $stmt2->bind_param('sis', $lecture_name, $lecture_lecturer, $lecture_notes);
    $stmt2->execute();
    $stmt2->close();
