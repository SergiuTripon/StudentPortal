...
switch($payment){
	...
	if ($p->validate_ipn()){ // validate the IPN, do the others stuffs here as per your app logic
		...
		$message .= "<tr><td style=\"border: 1px solid #FFA500;\"><strong>First name:</strong> </td><td>$firstname</td></tr>";
		$message .= "<tr><td style=\"border: 1px solid #FFA500;\"><strong>Surname:</strong> </td><td> $surname</td></tr>";
		$message .= "<tr><td style=\"border: 1px solid #FFA500;\"><strong>Email:</strong> </td><td> $email</td></tr>";
		$message .= "<tr><td style=\"border: 1px solid #FFA500;\"><strong>Invoice ID:</strong> </td><td> $invoice_id</td></tr>";
		$message .= "<tr><td style=\"border: 1px solid #FFA500;\"><strong>Transaction ID:</strong> </td><td> $transaction_id</td></tr>";
		$message .= "<tr><td style=\"border: 1px solid #FFA500;\"><strong>Payment:</strong> </td><td> $product_name</td></tr>";
		$message .= "<tr><td style=\"border: 1px solid #FFA500;\"><strong>Amount paid (&pound;):</strong> </td><td> &pound;$product_amount</td></tr>";
		$message .= "<tr><td style=\"border: 1px solid #FFA500;\"><strong>Payment time and date:</strong> </td><td> $payment_date</td></tr>";
		$message .= "<tr><td style=\"border: 1px solid #FFA500;\"><strong>Payment status:</strong> </td><td> $payment_status1</td></tr>";
		$message .= '</table>';
		$message .= '</body>';
		$message .= '</html>';
