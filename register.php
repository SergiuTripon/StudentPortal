...
<body>
    ...
    <div class="modal-body">
    <p class="text-justify"><b>Note:</b> The register facility is available to students only. If you're a lecturer, tutorial assistant or administrator, please contact an administrator who will create an account for you.</p>
    </div>
