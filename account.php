...
<body>
	...
	echo '<tr id="user-'.$row["userid"].'">
            ...
            <td data-title="Action"><a class="btn btn-primary btn-xs ladda-button" href="/admin/change-account-password?id='.$userid.'" data-style="slide-up"><span class="ladda-label">Change password</span></a></td>
