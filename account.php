...
<body>
	...
	echo '<tr id="user-'.$row["userid"].'">
            ...
            <td data-title="Change"><a id="change-'.$userid.'" class="btn btn-primary btn-md ladda-button change-button" data-style="slide-up"><span class="ladda-label">Change password</span></a></td>
