...
if (isset($_GET["id"])) {
    ...
    $stmt2->execute();
    $stmt2->store_result();
    $stmt2->bind_result($lecture_lecturer, $lecturer_feedback_to_email, $lecturer_feedback_to_firstname, $lecturer_feedback_to_surname);
    $stmt2->fetch();
    ...
    $stmt3->execute();
    $stmt3->store_result();
    $stmt3->bind_result($tutorial_assistant, $tutorial_assistant_feedback_to_email, $tutorial_assistant_feedback_to_firstname, $tutorial_assistant_feedback_to_surname);
    $stmt3->fetch();
