...
<body>
    ...
    <option style="color: #AD2121" class="others">University</option>
    <option style="color: #1E90FF" class="others">Work</option>
    <option style="color: #E3BC08" class="others">Personal</option>
	<option style="color: #006400" class="others">Other</option>
	</select>
	</div>
