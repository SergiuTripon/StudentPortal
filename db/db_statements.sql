...
FROM user_timetable
	...
	LEFT JOIN system_lectures ON system_lectures.lectureid=user_timetable.lectureid
	LEFT JOIN system_tutorials ON system_tutorials.tutorialid=user_timetable.tutorialid

WHERE user_timetable.userid = 1;
