...
<div class="preloader"></div>
	...
	$stmt1 = $mysqli->query("SELECT DISTINCT m.moduleid, m.module_name, m.module_notes, m.module_url, f.feedbackid, f.feedback_subject, f.feedback_body, f.isApproved, r.isRead, DATE_FORMAT(f.created_on,'%d %b %y %H:%i') as created_on FROM user_feedback_received r LEFT JOIN system_module m ON r.moduleid = m.moduleid LEFT JOIN user_feedback f ON r.feedbackid = f.feedbackid WHERE r.feedback_from = '$session_userid'");
