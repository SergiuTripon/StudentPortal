...
<div class="preloader"></div>
	...
	echo '<tr>
            ...
            <td data-title="Action"><a class="btn btn-primary btn-md ladda-button" href="../feedback/submit-lecture-feedback?lectureid='.$lectureid.'" data-style="slide-up"><span class="ladda-label">Feedback</span></a></td>
			</tr>';
	}
	...
	echo '<tr>
            ...
            <td data-title="Action"><a class="btn btn-primary btn-md ladda-button" href="../feedback/submit-tutorial-feedback?tutorialid='.$tutorialid.'" data-style="slide-up"><span class="ladda-label">Feedback</span></a></td>
			</tr>';
	}
