...
<div class="preloader"></div>
    ...
    <div class="panel-heading" role="tab" id="headingTwo">
  	<h4 class="panel-title">
	<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo"> Active lectures</a>
    </h4>
    </div>
    ...
    while($row = $stmt1->fetch_assoc()) {
        ...
        echo '<tr id="timetable-'.$moduleid.'">
			...
			<div class="modal-footer">
            <div class="view-action pull-left">
            <a href="#reactivate-'.$moduleid.'" data-dismiss="modal" data-toggle="modal" class="btn btn-primary btn-sm ladda-button" data-style="slide-up">Restore</a>
			</div>
			<div class="view-close pull-right">
			<a class="btn btn-danger btn-sm ladda-button" data-style="slide-up" data-dismiss="modal">Close</a>
			</div>
			...
			<div class="pull-left">
			<a id="reactivate-'.$moduleid.'" class="btn btn-success btn-lg reactivate-button ladda-button" data-style="slide-up">Yes</a>
			</div>
			<div class="text-right">
			<button type="button" class="btn btn-danger btn-lg ladda-button" data-style="slide-up" data-dismiss="modal">No</button>
			</div>
