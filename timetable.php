...
<div class="preloader"></div>
    ...
    $stmt2 = $mysqli->query("SELECT t.tutorialid, t.tutorial_name, t.tutorial_notes, m.module_url, d.firstname, d.surname, t.tutorial_day, DATE_FORMAT(t.tutorial_from_time,'%H:%i') as tutorial_from_time, DATE_FORMAT(t.tutorial_to_time,'%H:%i') as tutorial_to_time, t.tutorial_location, t.tutorial_capacity FROM system_tutorials t LEFT JOIN user_tutorial u ON t.tutorialid = u.tutorialid LEFT JOIN system_modules m ON t.moduleid = m.moduleid LEFT JOIN user_details d ON t.tutorial_assistant = d.userid WHERE t.tutorial_status = 'active' AND u.userid = '3' AND t.tutorial_day = 'Monday'");
